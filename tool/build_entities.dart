...
const ruNameOverrides = {
  ...
  // Имя пришло из текста в родительном падеже («Газы», «сыновья Газзама»), а
  // Некоде и вовсе досталось соседнее по стиху имя (Езд 2:48).
  'Gaza@Gen.10.19-Act': 'Газа',
  'Gazzam@Ezr.2.48-Neh': 'Газзам',
  'Nekoda@Ezr.2.48-Neh': 'Некода',
